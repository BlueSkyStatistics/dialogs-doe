        ...
        var objects = {
			...
			*/
            ...
            steepestHandComputedChk: {
                el: new checkbox(config, {
                    label: RSMFormula.t('steepestHandComputedChk'),
            ...
            createOptimLmChk: {
                el: new checkbox(config, {
                    label: RSMFormula.t('createOptimLmChk'),
                    no: "createOptimLmChk",
                    bs_type: "valuebox",
                    style: "mt-2 mb-2",
                    extraction: "BooleanValue",
			...
			checkADNormalityTestChk: {
                el: new checkbox(config, {
                    label: RSMFormula.t('checkADNormalityTestChk'), 
			...
			showResidualPlotsChk: {
                el: new checkbox(config, {
                    label: RSMFormula.t('showResidualPlotsChk'),
			...
			flipaxisPPplotChk: { 
                el: new checkbox(config, {
                    label: RSMFormula.t('flipaxisPPplotChk'), 
			...
			deGroupPlotsChk: {
                el: new checkbox(config, {
                    label: RSMFormula.t('deGroupPlotsChk'),
					no: "deGroupPlotsChk",
                    bs_type: "valuebox",
                    extraction: "BooleanValue",
                    true_value: "TRUE",
			...
			observationDiagnosticsChk: {
                el: new checkbox(config, {
                    label: RSMFormula.t('observationDiagnosticsChk'),
            ...
            stepwiseSectionLbl: {
                el: new labelVar(config, {
                    label: RSMFormula.t('stepwiseSectionLbl'),
                    style: "mt-4 mb-1",
                    h: 5,
                })
            },
            stepwiseChk: {
                el: new checkbox(config, {
                    label: RSMFormula.t('stepwiseChk'),
                    no: "stepwiseChk",
                    bs_type: "valuebox",
                    style: "mt-1 mb-1",
                    extraction: "BooleanValue",
            ...
            stepwiseMethod: {
                el: new comboBox(config, {
                    no: "stepwiseMethod",
                    label: RSMFormula.t('stepwiseMethodLbl'),
                    multiple: false,
                    extraction: "NoPrefix|UseComma",
            ...
            stepwiseCriterion: {
                el: new comboBox(config, {
                    ...
                    label: RSMFormula.t('stepwiseCriterionLbl'),
                    multiple: false,
                    extraction: "NoPrefix|UseComma",
                    style: "ml-4 mt-1 mb-1",
                    options: ["AICc", "BIC"],
            ...
            alphaEnter: {
                el: new input(config, {
                    no: "alphaEnter",
                    label: RSMFormula.t('alphaEnterLbl'),
                    placeholder: "0.15",
                    allow_spaces: true,
                    extraction: "TextAsIs",
                    style: "ml-4 mt-1 mb-1",
            ...
            alphaRemove: {
                el: new input(config, {
                    no: "alphaRemove",
                    label: RSMFormula.t('alphaRemoveLbl'),
                    placeholder: "0.15",
                    allow_spaces: true,
                    extraction: "TextAsIs",
                    style: "ml-4 mt-1 mb-1",
            ...
            hierarchyChk: {
                el: new checkbox(config, {
                    label: RSMFormula.t('hierarchyChk'),
                    no: "hierarchyChk",
                    bs_type: "valuebox",
                    style: "ml-4 mt-1 mb-1",
                    extraction: "BooleanValue",
            ...
            showStepDetailChk: {
                el: new checkbox(config, {
                    label: RSMFormula.t('showStepDetailChk'),
            ...
            stepwiseNote: {
                el: new labelVar(config, {
                    label: RSMFormula.t('stepwiseNote'),
