...
var localization = {
    en: {
		...
		axialCenterPointRowsChk:"If any, identify the row numbers for center points and axial/star points",
		
        summarizeBriefChk:"Summarize (brief)",//summarizeBrief

        summarizeDetailsChk:"Summarize (detail)",//summarizeDetails
		
		printDesignChk:"Print Design", //call the BSkyFormat on the design object 
		printDesignWithRunOrderChk: "Print Design with Run Order",

        designinfoChk:"Advance option - Details of the design object with design.info()" //designinfo
    }
}
    ...
    constructor() {
        ...
        var objects = {
           ...
           // summarizeBrief: { el: new checkbox(config, { label: localization.en.summarizeBrief, no: "summarizeBrief", extraction: "Boolean", newline: true }) },
			...
			summarizeBriefChk: {
                el: new checkbox(config, {
                    label: localization.en.summarizeBriefChk,
			...
			summarizeDetailsChk: {
                el: new checkbox(config, {
                    label: localization.en.summarizeDetailsChk,
			...
			printDesignChk: {
                el: new checkbox(config, {
                    label: localization.en.printDesignChk,
                    no: "printDesignChk",
                   // style: "ml-5",
                    bs_type: "valuebox",
                    extraction: "BooleanValue",
			...
			designinfoChk: {
                el: new checkbox(config, {
                    label: localization.en.designinfoChk,
                    no: "designinfoChk",
                    //style: "ml-5",
                    bs_type: "valuebox",
                    extraction: "BooleanValue",
